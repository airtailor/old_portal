class AirtailorMailer < ApplicationMailer
  ...
  def label_email(customer, order)
    ...
    label = PDFKit.new "<img src=" + @order.inbound_label.to_s + " style='display:block; ms-transform: rotate(90deg); -webkit-transform: rotate(90deg);  transform: rotate(90deg); margin:0; margin-left:150px; width:65%;'>
