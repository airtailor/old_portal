class AirtailorMailer < ApplicationMailer
  ...
  def label_email(owner, customer, order)
    ...
    label = PDFKit.new "<img src=" + @order.inbound_label.to_s + " style='display:block; ms-transform: rotate(90deg); -webkit-transform: rotate(90deg);  transform: rotate(90deg); margin:0; margin-left:175px; margin-top: -175px; margin-bottom:-125px; width:65%; padding:0'>
      <img src='http://i.imgur.com/yJwSRrn.png' style='margin:0;padding:0';margin-top:-100px><p style='text-align:center;font-size:24px;'>PUT THIS HALF IN WITH YOUR ORDER<br>PLEASE SHIP US YOUR ORDER WITHIN 10 DAYS</p><h2 style='text-align:center; padding:0; margin:0; font-size:120px'>" + @order.shopify_id.to_s + "</h2>"
