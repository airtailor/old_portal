  ...
  def index
    ...
    if @order.arrived == true && @order.counter == 0
      if @customer.phone.blank?
        ...
        SendSonar.message_customer(text: "When we're done, we'll ship it directly to " + @customer.address1 + ", " + @customer.address 2 + ", " + @customer.city ", " + @customer.state + " " + @customer.zip ". Is that still correct? Thank you!", to: @customer.phone)
      end
