class ItemsController < ApplicationController
  ...
  def index
    ...
    if @order.complete == true && @order.counter == 1
      SendSonar.message_customer(text: "Good news " + @customer.first_name.capitalize + " — your Air Tailor order (" + @order.shopify_id + ") is finished and on its way to you! Here's your USPS tracking number: " + @order.tracking_number, to: @customer.phone,media_url:"https://media.giphy.com/media/12UlfHpF05ielO/giphy.gif")
